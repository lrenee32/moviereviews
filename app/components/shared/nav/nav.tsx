...
export const Nav: FunctionComponent<Props> = (props: Props) => {
  ...
  return (
    <>
      ...
      <Backdrop open={searchOpen} sx={{ zIndex: '999', backgroundColor: 'rgba(0,0,0,.9)' }}>
      <CloseIcon sx={{ position: 'absolute', top: '0', right: '0', m: '20px', zIndex: '1000', '&:hover': { cursor: 'pointer' } }} onClick={() => setSearchOpen(false)} />
